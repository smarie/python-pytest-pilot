...
TESTS_REQUIRE = ['pytest', 'pytest-logging', 'pytest-harvest']
EXTRAS_REQUIRE = {}
...
setup(
    ...
    # we're using git
    use_scm_version={'write_to': 'pytest_pilot/_version.py'}, # this provides the version + adds the date if local non-commited changes.
    ...
    entry_points={"pytest11": ["pilot = pytest_pilot.plugin"]},
)
